...
- story: "מר בערך ערבב את הוראות האירוע."
- objective: "ארגנו את עמדות ההשקה לתושבי הרובע."

**הוראת הביצוע (מוצגת במסך ההרכבה):** "בחרו מטרה, הקשר ופורמט."

**משוב על בחירה שגויה (שם את הרכיב החסר/עמום, לא חושף את התשובה):**
  - **"הדפס פוסטרים לאירוע"**: הפוסטרים מוכנים, אבל העמדות אינן מאורגנות. זו מטרה לא מדויקת למשימה שהוגדרה.
  - **"עבור צוות התחזוקה"**: העמדות מסודרות לקהל אחר. ההקשר (הקהל) לא תואם את תושבי הרובע.
  - **"כפסקה אחת על כרזה"**: התכנית נכונה, אבל קשה לקרוא אותה בכיכר. הפורמט (פסקה על כרזה) לא שימושי לקהל גדול.

**הסבר הצלחה (מוצג עם "למה זה עבד?" לאחר ניצחון):**
"לארגן (מטרה), עבור תושבי הרובע (הקשר) וכטבלה על לוח הכיכר (פורמט) — שלושת הרכיבים יחד נותנים ללופּ הוראה מלאה שאי אפשר לפרש לא נכון. כל רכיב חסר משאיר פרצה לפרשנות שגויה."
