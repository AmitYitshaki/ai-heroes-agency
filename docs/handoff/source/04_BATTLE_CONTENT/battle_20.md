...
- story: "הלוח נראה רשמי, אבל שעת התדריך לא נבדקה."
- objective: "אמתו את השעה לפני האישור."

**הוראת הביצוע (מוצגת במסך ההרכבה):** "בחרו מקור נפרד ומתאים."

**משוב על בחירה שגויה (שם את הרכיב החסר/עמום, לא חושף את התשובה):**
  - **"אשרו כי הלוח נראה רשמי"**: עיצוב רשמי אינו ראיה. לא בוצע אימות מול מקור נפרד.
  - **"שאלו שוב את אותו AI"**: תשובה נוספת מאותו מקור אינה אימות עצמאי. אימות דורש מקור שונה מהתשובה עצמה.

**הסבר הצלחה (מוצג עם "למה זה עבד?" לאחר ניצחון):**
"מדריך המשימה המאושר נוצר בנפרד מהתשובה של ה־AI, ולכן השוואה אליו היא אימות אמיתי — לא רק בדיקה שהתשובה נראית נכונה. עיצוב רשמי או ביטחון בניסוח אינם הוכחה."
