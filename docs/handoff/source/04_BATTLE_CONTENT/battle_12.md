...
- story: "המילה ״טובה״ אפשרה גם לסוללות קצרות לעבור."
- objective: "אשרו רק סוללה שעובדת יותר משעתיים."

**הוראת הביצוע (מוצגת במסך ההרכבה):** "בחרו מבחן מדיד לפי ספר הנהלים."

**משוב על בחירה שגויה (שם את הרכיב החסר/עמום, לא חושף את התשובה):**
  - **"האם הסוללה טובה?"**: שתי הסוללות קיבלו סימן שאלה. "טובה" אינה קריטריון מדיד.
  - **"האם הסוללה כבדה?"**: זה מדיד, אבל לא קשור לכלל. הקריטריון חייב להתאים למה שהמדריך בודק בפועל.

**הסבר הצלחה (מוצג עם "למה זה עבד?" לאחר ניצחון):**
"זמן עבודה גדול משעתיים הוא קריטריון מדיד שאפשר לבדוק מול נתון אמיתי — בדיוק מה שהנוהל דורש. קריטריון הצלחה אומר איך יודעים שהתוצאה טובה מספיק, בניגוד למילה כללית כמו "טובה"."
