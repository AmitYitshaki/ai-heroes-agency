...
- story: "מר בערך מחק את המקום והזמן מבקשת התאורה."
- objective: "האירו את מפת הסיור בחוץ בערב."

**הוראת הביצוע (מוצגת במסך ההרכבה):** "בחרו הקשר שמתאים לסביבה."

**משוב על בחירה שגויה (שם את הרכיב החסר/עמום, לא חושף את התשובה):**
  - **"בתוך חדר בבוקר"**: אור החדר שוטף את המפה ואינו מתאים לסיור. חסר ההקשר הנכון: מקום וזמן הפעילות.
  - **"באולם חשוך, להצגה"**: זרקור במה מאיר רק פינה אחת של המפה. גם כאן ההקשר — מקום וזמן — לא תואם לסיור בחוץ.

**הסבר הצלחה (מוצג עם "למה זה עבד?" לאחר ניצחון):**
"בחוץ בערב צריך תאורה חזקה לקריאת מפה בחושך — זה מה שהבחירה הזו מספקת. מקום וזמן הם חלק מההקשר: הם אומרים ל־AI באילו תנאים התוצאה צריכה לפעול בפועל."
