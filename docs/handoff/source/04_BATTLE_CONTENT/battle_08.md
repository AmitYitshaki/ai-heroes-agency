...
- story: "עוד־ועוד מחק את נקודת העצירה מהמסוע."
- objective: "ייצרו כמות מדויקת של תיבות."

**הוראת הביצוע (מוצגת במסך ההרכבה):** "בחרו גבול שאפשר לספור מראש."

**משוב על בחירה שגויה (שם את הרכיב החסר/עמום, לא חושף את התשובה):**
  - **"הרבה תיבות"**: ״הרבה״ אינו מספר. לופּ לא יודע מתי לעצור — האילוץ עדיין לא מדיד.
  - **"עד שאזור האיסוף יתמלא"**: המסוע עצר רק כשהאזור כבר התמלא. האילוץ תלוי בתנאי משתנה, לא במספר קבוע.

**הסבר הצלחה (מוצג עם "למה זה עבד?" לאחר ניצחון):**
""בדיוק חמש תיבות" הוא מספר מדויק שאפשר לספור ולבדוק — זה מה שנותן ללופּ נקודת עצירה. אילוץ מדיד מונע פרשנויות כמו "הרבה" או "עד שמתמלא", שאין להן גבול ברור."
