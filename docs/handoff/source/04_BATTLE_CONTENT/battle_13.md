...
- story: "שער הבקרה עצר אריזות שחסרים להן שלושה כלי פיקוח."
- objective: "בקרו את האריזות לפני היציאה."

**הוראת הביצוע (מוצגת במסך ההרכבה):** "בחרו אילוץ, דוגמה וקריטריון."

**משוב על בחירה שגויה (שם את הרכיב החסר/עמום, לא חושף את התשובה):**
  - **"קל ככל האפשר"**: אין גבול שאפשר למדוד. "קל ככל האפשר" אינו אילוץ מדיד.
  - **"משהו יפה ומרשים"**: לא ניתנה תבנית ברורה. "משהו יפה ומרשים" הוא תיאור, לא דוגמה קונקרטית.
  - **"בדוק שהאריזה נראית טוב"**: מראה טוב אינו מבחן אטימות. הקריטריון לא בודק את התכונה הנדרשת.

**הסבר הצלחה (מוצג עם "למה זה עבד?" לאחר ניצחון):**
"משקל מרבי, דוגמת האריזה התקנית ובדיקת האטימות פועלים יחד: האילוץ קובע גבול, הדוגמה מראה צורה, והקריטריון בודק תוצאה. בלעדי אחד מהם, קל לפרש את הבקשה בדרך שלא עומדת בבקרת האיכות."
