...
- story: "לופּ עשה משהו כיפי, אבל לא התחילה פעילות."
- objective: "ארגנו פעילות היכרות קצרה."

**הוראת הביצוע (מוצגת במסך ההרכבה):** "החליפו את המטרה העמומה במשימה ברורה."

**משוב על בחירה שגויה (שם את הרכיב החסר/עמום, לא חושף את התשובה):**
  - **"הפעל מוזיקת רקע"**: המוזיקה פועלת, אבל עדיין אין פעילות היכרות. המטרה עדיין לא מגדירה איזו פעילות לבצע.
  - **"הכן הפתעה לקבוצה"**: הוכנה הפתעה, אבל לא הוגדרה פעילות. גם כאן חסרה מטרה שמתארת פעולה קונקרטית.

**הסבר הצלחה (מוצג עם "למה זה עבד?" לאחר ניצחון):**
""ארגן משחק היכרות של חמש דקות" הוא פועל פעולה קונקרטי שאומר בדיוק מה לבנות וכמה זמן. מטרה ברורה מחליפה ניסוח מעורפל כמו "תעשה משהו כיף" בפעולה שאפשר לבצע ולבדוק."
