...
- story: "תסבוכת שינתה כמה חלקים יחד. קשה לדעת מה עבד."
- objective: "בדקו שינוי אחד לעומת גרסת הבסיס."

**הוראת הביצוע (מוצגת במסך ההרכבה):** "בחרו ניסוי שמבודד שינוי אחד."

**משוב על בחירה שגויה (שם את הרכיב החסר/עמום, לא חושף את התשובה):**
  - **"גרסת הבסיס ללא שינוי"**: לא בדקנו את שיטת המיון החדשה. בלי לשנות משתנה, אי אפשר לבחון שיפור.
  - **"שנו צבע, מגירות ומדבקות"**: כמה דברים השתנו יחד, ולכן לא נדע מה השפיע. האיטרציה לא מבודדת משתנה אחד.

**הסבר הצלחה (מוצג עם "למה זה עבד?" לאחר ניצחון):**
"שינוי של שיטת המיון בלבד, בלי לגעת בשאר הרכיבים, מאפשר להשוות במדויק בין הגרסה הישנה לחדשה. איטרציה מבוקרת — שינוי משתנה אחד בכל בדיקה — הופכת תיקון להסבר ברור, לא לניחוש."
